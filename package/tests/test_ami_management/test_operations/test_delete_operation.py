...
class TestDeleteOperation(TestCase):
    def setUp(self):
        ...
        self.instance = Mock()
        self.delete_operation.aws_ec2_service.get_instance_by_id = Mock(return_value=self.instance)

    def test_delete_operation(self):
        self.delete_operation.delete_instance(self.ec2_session, 'id')

        self.assertTrue(self.delete_operation.aws_ec2_service.get_instance_by_id.called_with(self.ec2_session, 'id'))
