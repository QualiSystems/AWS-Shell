...
class TestAmiCredentialsService(TestCase):
    def setUp(self):
        ...
        self.credentials_service = AMICredentialsService(self.password_waiter)
    ...
    def test_get_windows_credentials_wait(self):
        ...
        self.assertEqual(self.decrypted, self.credentials_service.decrypt_password(self.pem, self.encrypted))
