...
class PrepareSubnetExecutor(object):
    ...
    def __init__(self, ec2_session, ec2_client, cancellation_service, cancellation_context, vpc_service, subnet_service,
                 tag_service, subnet_waiter, logger, reservation, aws_ec2_datamodel):
